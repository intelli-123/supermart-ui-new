...
-- ── Stores ───────────────────────────────────────────────────────────────────
INSERT IGNORE INTO stores (store_id, store_code, store_name, address, city, state, zip_code, created_at) VALUES
...
-- ── Equipment Units ───────────────────────────────────────────────────────────
INSERT IGNORE INTO equipment_units (unit_id, store_id, unit_type, unit_name, location_desc, created_at) VALUES
...
-- ── IoT Devices ───────────────────────────────────────────────────────────────
INSERT IGNORE INTO iot_devices (device_id, unit_id, device_serial, device_key, min_temp_threshold, max_temp_threshold, status, last_seen_at) VALUES
...
-- ── Technicians ───────────────────────────────────────────────────────────────
INSERT IGNORE INTO technicians (technician_id, full_name, email, phone, region) VALUES
...
-- ── Telemetry Records ─────────────────────────────────────────────────────────
INSERT IGNORE INTO telemetry_records (telemetry_id, device_id, temperature, recorded_at, is_alert) VALUES
...
-- ── Incidents ─────────────────────────────────────────────────────────────────
INSERT IGNORE INTO incidents (incident_id, device_id, incident_type, status, description, created_at, resolved_at) VALUES
